...
export const NodeSelector = ({ open, onOpenChange }) => {
  ...
  return (
    <Popover modal={true} open={open} onOpenChange={onOpenChange}>
      ...
      <PopoverContent sideOffset={5} align="start" className="w-48 p-1 rounded-lg">
        {items.map((item) => (
          <EditorBubbleItem
            key={item.name}
            onSelect={(editor) => {
            ...
            className="flex cursor-pointer items-center justify-between rounded-md p-1.5 text-sm hover:bg-neutral-100"
          >
